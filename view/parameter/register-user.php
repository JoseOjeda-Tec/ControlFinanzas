            ...
            <div class="container-body d-flex">
                ...
                <div class="side-bar-options mb-3 ml-3 mr-3 mt-0">
                    ...
                    <div class="list-forms">
                        ...
                        <button type="button" id="btn-user-form" class="form-btn-side btn-dark-ing form-btn-active">Usuarios <i class="fa-solid fa-users"></i></button>
                    </div>
                ...
                <div class="content-info-body mb-3 ml-0 mr-3 mt-0">
                    ...
                    <div class="title-body-active d-flex justify-content-center text-center m-3">
                        <h1 id="title-body-id" class="title-body">Registro de Usuarios</h1>
                    </div>
...
<script src="../../config/js/register-user.js"></script>
</html>