            ...
            <div class="container-body d-flex">
                ...
                <div class="side-bar-options mb-3 ml-3 mr-3 mt-0">
                    ...
                    <div class="list-forms">
                        ...
                        <button type="button" id="btn-logs-form" class="form-btn-side btn-dark-ing form-btn-active">Logs <i class="fa-solid fa-timeline"></i></button>
                ...
                <div class="content-info-body mb-3 ml-0 mr-3 mt-0">
                    ...
                    <div class="title-body-active d-flex justify-content-center text-center m-3">
                        <h1 id="title-body-id" class="title-body">Listado de Logs</h1>
                    </div>
...
<script src="../../config/js/register-logs.js"></script>
</html>